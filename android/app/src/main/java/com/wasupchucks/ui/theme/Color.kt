...
val ChucksGreen = Color(0xFF4CAF50)
val ChucksGreenDark = Color(0xFF388E3C)
val ChucksOrange = Color(0xFFFF9800)
val ChucksOrangeDark = Color(0xFFF57C00)

// Status colors
val StatusOpen = ChucksGreen
val StatusClosed = ChucksOrange
val StatusOpenContainer = Color(0xFFE8F5E9)
val StatusClosedContainer = Color(0xFFFFF3E0)

// Allergen colors
val AllergenDietary = ChucksGreen
val AllergenWarning = ChucksOrange
val AllergenDietaryContainer = Color(0xFFE8F5E9)
val AllergenWarningContainer = Color(0xFFFFF3E0)

// Light theme colors
val md_theme_light_primary = Color(0xFF4CAF50)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFB8F5B1)
...
val md_theme_dark_inversePrimary = Color(0xFF006D21)
val md_theme_dark_surfaceTint = Color(0xFF9DD897)
